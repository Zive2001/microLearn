...
// Static file serving for uploads (audio previews, videos, etc.)
...
const testVideoRoutes = require('./routes/testVideoRoutes');
...
app.use('/api/test-videos', testVideoRoutes); // 🧪 Test routes for micro-learning shorts
